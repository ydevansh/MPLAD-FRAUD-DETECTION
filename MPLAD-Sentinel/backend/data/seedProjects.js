...
const projectsData = [
  ...
  // ── 2. HIGH EXPENDITURE + LOW PROGRESS (Significant Gap) ──────────────────────
  {
    ...
    releasedAmount: 48.0,
    expenditure: 45.0,         // 90% expenditure
    physicalProgress: 35,       // Only 35% progress -> difference: +55% (SIGNIFICANT_GAP)
    status: 'Ongoing',
  ...
  // ── 19. BIHAR: PATNA - Severe Gap Project (88% Spent, 22% Physical) ──────────
  {
    ...
    sanctionedAmount: 40.0,
    releasedAmount: 38.0,
    expenditure: 35.2,         // 88% spent
    physicalProgress: 22,       // 22% progress -> Gap: 66%
    status: 'Ongoing',
    sanctionDate: new Date('2024-08-15'),
